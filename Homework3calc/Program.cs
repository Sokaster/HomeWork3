...
namespace MyApp // Note: actual namespace depends on the project name.
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            while (i != -1)
            {
                Console.WriteLine(@"Press operation: + - % / * " + Environment.NewLine + "f(for factorial) s(for sqrt)" + Environment.NewLine + "k(for sqr) e(for exponentation)" + Environment.NewLine + "-1 to Exit Programm");
